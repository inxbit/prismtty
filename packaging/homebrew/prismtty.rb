class Prismtty < Formula
  ...
  homepage "https://github.com/nzkller/prismtty"
  version "0.1.0"
  license "MIT"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/nzkller/prismtty/releases/download/v#{version}/prismtty-#{version}-darwin-aarch64.tar.gz"
      sha256 "REPLACE_WITH_DARWIN_AARCH64_SHA256"
    else
      url "https://github.com/nzkller/prismtty/releases/download/v#{version}/prismtty-#{version}-darwin-x86_64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/nzkller/prismtty/releases/download/v#{version}/prismtty-#{version}-linux-aarch64.tar.gz"
      sha256 "REPLACE_WITH_LINUX_AARCH64_SHA256"
    else
      url "https://github.com/nzkller/prismtty/releases/download/v#{version}/prismtty-#{version}-linux-x86_64.tar.gz"
